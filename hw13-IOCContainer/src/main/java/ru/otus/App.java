...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //AppComponentsContainer container = new AppComponentsContainerImpl(AppConfigFirstPart.class, AppConfigSecondPart.class, AppConfigThirdPart.class);

        // Тут можно использовать библиотеку Reflections (см. зависимости)
        AppComponentsContainer container = new AppComponentsContainerImpl("ru.otus.config.parts");
